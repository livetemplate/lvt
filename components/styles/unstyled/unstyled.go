...
// Adapter provides BEM class names for all components without any visual styling.
// Users can target these classes in their own CSS to customize appearance.
type Adapter struct{}
...
func (a *Adapter) BreadcrumbItemStyles() styles.BreadcrumbItemStyles { return breadcrumbItemStyles() }
...
func (a *Adapter) ConfirmModalStyles() styles.ConfirmModalStyles   { return confirmModalStyles() }
...
func (a *Adapter) ProgressStyles() styles.ProgressStyles           { return progressStyles() }
...
func (a *Adapter) AvatarSkeletonStyles() styles.AvatarSkeletonStyles { return avatarSkeletonStyles() }
func (a *Adapter) CardSkeletonStyles() styles.CardSkeletonStyles     { return cardSkeletonStyles() }
...
func (a *Adapter) TimelineItemStyles() styles.TimelineItemStyles     { return timelineItemStyles() }
