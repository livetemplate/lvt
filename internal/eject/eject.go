...
func AvailableComponents() []ComponentInfo {
	return []ComponentInfo{
		{Name: "accordion", Package: "github.com/livetemplate/lvt/components/accordion", Description: "Collapsible content sections", Templates: []string{"default", "single"}},
		{Name: "autocomplete", Package: "github.com/livetemplate/lvt/components/autocomplete", Description: "Search with suggestions", Templates: []string{"default"}},
		{Name: "breadcrumbs", Package: "github.com/livetemplate/lvt/components/breadcrumbs", Description: "Navigation breadcrumb trail", Templates: []string{"default"}},
		{Name: "datatable", Package: "github.com/livetemplate/lvt/components/datatable", Description: "Data tables with sorting/pagination", Templates: []string{"default"}},
		{Name: "datepicker", Package: "github.com/livetemplate/lvt/components/datepicker", Description: "Date selection", Templates: []string{"single", "range", "inline"}},
		{Name: "drawer", Package: "github.com/livetemplate/lvt/components/drawer", Description: "Slide-out panels", Templates: []string{"default"}},
		{Name: "dropdown", Package: "github.com/livetemplate/lvt/components/dropdown", Description: "Dropdown menus", Templates: []string{"default", "searchable", "multi"}},
		{Name: "menu", Package: "github.com/livetemplate/lvt/components/menu", Description: "Navigation menus", Templates: []string{"default", "nested"}},
		{Name: "modal", Package: "github.com/livetemplate/lvt/components/modal", Description: "Modal dialogs", Templates: []string{"default", "confirm", "sheet"}},
		{Name: "popover", Package: "github.com/livetemplate/lvt/components/popover", Description: "Rich content popovers", Templates: []string{"default"}},
		{Name: "progress", Package: "github.com/livetemplate/lvt/components/progress", Description: "Progress indicators", Templates: []string{"default", "circular", "spinner"}},
		{Name: "rating", Package: "github.com/livetemplate/lvt/components/rating", Description: "Star ratings", Templates: []string{"default"}},
		{Name: "skeleton", Package: "github.com/livetemplate/lvt/components/skeleton", Description: "Loading placeholders", Templates: []string{"default", "avatar", "card"}},
		{Name: "tabs", Package: "github.com/livetemplate/lvt/components/tabs", Description: "Tab navigation", Templates: []string{"horizontal", "vertical", "pills"}},
		{Name: "tagsinput", Package: "github.com/livetemplate/lvt/components/tagsinput", Description: "Tag/chip input", Templates: []string{"default"}},
		{Name: "timeline", Package: "github.com/livetemplate/lvt/components/timeline", Description: "Event timelines", Templates: []string{"default"}},
		{Name: "timepicker", Package: "github.com/livetemplate/lvt/components/timepicker", Description: "Time selection", Templates: []string{"default"}},
		{Name: "toast", Package: "github.com/livetemplate/lvt/components/toast", Description: "Toast notifications", Templates: []string{"default", "container"}},
		{Name: "toggle", Package: "github.com/livetemplate/lvt/components/toggle", Description: "Toggle switches", Templates: []string{"default", "checkbox"}},
		{Name: "tooltip", Package: "github.com/livetemplate/lvt/components/tooltip", Description: "Tooltips", Templates: []string{"default"}},
	}
}
