...
func TestEmbeddedResourceGeneration(t *testing.T) {
	...
	err := GenerateResource(tmpDir, "testapp", "posts", postFields, "multi", "tailwind", "tailwind", "infinite", 20, "page", "")
	if err != nil {
	...
	err = GenerateResource(tmpDir, "testapp", "comments", commentFields, "multi", "tailwind", "tailwind", "infinite", 20, "modal", "posts")
	if err != nil {
...
func TestEmbeddedResourceGeneration_MissingParent(t *testing.T) {
	...
	err := GenerateResource(tmpDir, "testapp", "comments", fields, "multi", "tailwind", "tailwind", "infinite", 20, "modal", "posts")
	if err == nil {
...
func TestEmbeddedResourceGeneration_MissingReferenceField(t *testing.T) {
	...
	if err := GenerateResource(tmpDir, "testapp", "posts", postFields, "multi", "tailwind", "tailwind", "infinite", 20, "page", ""); err != nil {
		t.Fatalf("failed to generate posts: %v", err)
	}
