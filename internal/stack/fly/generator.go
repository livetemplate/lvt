...
//go:embed templates/fly.toml.tmpl
var flyTomlTemplate string
...
// Generator implements stack.Generator for Fly.io
type Generator struct{}

// New creates a new Fly.io generator
func New() *Generator {
	return &Generator{}
}

// Generate creates Fly.io deployment configuration
...
// Validate validates Fly.io deployment configuration
func (g *Generator) Validate(ctx context.Context, stackDir string) error {
	// TODO: Implement validation
	return nil
}

// GetInfo returns information about the Fly.io stack
