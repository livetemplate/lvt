...
func printGenResourceHelp() {
	...
	fmt.Println()
	fmt.Println("Options:")
	fmt.Println("  --parent <name>     Embed this resource in the parent's detail page")
	...
	fmt.Println("  lvt gen resource comments post_id:references:posts author text --parent posts")
	fmt.Println()
	fmt.Println("Run 'lvt --help' for full documentation.")
}
...
func printComponentListHelp() {
	...
	fmt.Println()
	fmt.Println("Lists all components available from github.com/livetemplate/lvt/components")
...
func printComponentEjectHelp() {
	...
	fmt.Println("  from: github.com/livetemplate/lvt/components/<name>")
...
func printNewComponentHelp() {
	...
	fmt.Println("  - Submit PR to github.com/livetemplate/lvt/components")
