...
<body>
	...
	<form>
		...
		<button type="button" id="increment-btn" lvt-on:click="increment">Increment Counter</button>
	</form>
	<script src="/client.js"></script>
</body>
</html>`
...
<body>
	...
	<form>
		...
		<button type="button" id="trigger-btn" lvt-on:click="increment">Trigger Update</button>
	</form>
	<script src="/client.js"></script>
</body>
</html>`
